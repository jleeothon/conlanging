...
Examples: _sikron / sikron_ "to secure", _anþron_ "to change".
...
A preposition governs these cases:

- with a pronoun, the accusative,
- otherwise (i.e. nouns), the nominative.
...
| uf (on)        |                | up (onto)      | ovin, bovin        | ovir          | up af    | upir (upra)    |
...
- _Þänkew at skolen onnon þen kokueda laukan þein._ "I think that they will
