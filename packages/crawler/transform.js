...
const dataString = readFileSync('./data/data-1.json', 'utf-8');
const entries = JSON
	.parse(dataString)
...
const transformations = [
	...
	},
	{
		...
		do(lemma) {
			...
			const replaced = lemma.replaceAll(re, (_, vowel, consonants) => applyUmlaut(vowel) + consonants + 'ij');
			return replaced;
		},
	},
	{
		...
		do(lemma) {
			...
			const result = lemma.replaceAll(re, (_, vowel, consonants) => applyUmlaut(vowel) + consonants + 'j');
			return result;
		},
	},
	{
